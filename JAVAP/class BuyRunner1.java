class BuyRunner1 {
    public static void main(String[] args) {
        ...
        Buy.buyEgg(10, 60);
        Buy.buyEgg(5, -60); // Added a negative case
        ...
        Buy.buyLaptop("Fastrack", -58796, 59000, 90, 55, "Windows", 500, 250);
        Buy.buySmartWatch("Fastrack", 6000, 1, 'L', 1); // Changed int to valid values
        Buy.buySmartWatch("Samsung", 6000, 2, 'L', 1); // Changed int to valid values
    }
}