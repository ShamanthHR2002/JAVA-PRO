 class FishRunner4 {
    public static void main(String[] args) {
        ...
        Fish4 fish1 = new Fish4("anjal", "small");
        Fish4 fish2 = new Fish4("gold", "large");
        Fish4 fish3 = new Fish4("tuna", "medium");
        Fish4 fish12 = new Fish4("salmon", "small");
        Fish4 fish5 = new Fish4("trout", "large");
        Fish4 fish6 = new Fish4("catfish", "medium");
        Fish4 fish7 = new Fish4("mackerel", "small");
        Fish4 fish8 = new Fish4("bass", "large");
        Fish4 fish9 = new Fish4("haddock", "medium");
        Fish4 fish10 = new Fish4("cod", "small");
        Fish4 fish11 = new Fish4("sardine", "large");
